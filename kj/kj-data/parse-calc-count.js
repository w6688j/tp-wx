...
exports.PCDDZH=function(betData, kjData, Groupname){
	...
	if(bet=='大'){
        ...
        if(kjhe%2==0 &&kjhe<=13) count=1;
        return count;
    }else if(bet=='大单'){
        if(kjhe%2!==0 &&kjhe>=14) count=1;
        return count;
    }else if(bet=='小单'){
        if(kjhe%2!==0 &&kjhe<=13){
        	if(kjhe==13){
...
//时时彩综合玩法结束
//天津时时彩综合
exports.tjsscgy=function(bet, kj){
    var kj=kj.split(',');
    var val=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);
    var vala=parseInt(kj[0],10);
    var val5=parseInt(kj[4],10);
...
//重庆时时彩综合玩法
//号码为0到9
exports.tjssczh=function(betData, kjData, Groupname){
    var kj=kjData.split(',');
    var bet=betData;
    var count=0;
    var val='';
